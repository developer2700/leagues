...
class LeagueTeamController extends InsiderRestFullControllerAbstract
{
    /** @var LeagueTeamService */
    private $Service;

    public function __construct(LeagueTeamService $service)
    {
    ...
    {
        try {
            return response()->json($this->Service->getByLeagueId($id), 200);
        } catch (EntryNotFoundException $e) {
            return response()->json('Model Not Fund', '404');
        }
    }
